  ...
  return (
    ...
    <label>
      ...
      <div className="col-md-6">
        <label>
          Roof Width:
          <input type="number" value={roofWidth} required 
      ...
      <div className="col-md-6">
        <label>
          Roof Height:
          <input type="number" value={roofHeight} required 
        ...
        <label>
        Row Spacing:
          <input type="number" value={rowSpacing} 
        ...
        <label>
        Column Spacing:
          <input type="number" value={columnSpacing} 
